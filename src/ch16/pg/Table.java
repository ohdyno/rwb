...
public class Table extends JFrame {
  ...
  public Table() {
    super("Planning ch14.ttt.Game Simulation");
    final JComponent buttons = makeButtons();
  ...
  private void makeCustomerButtons(final JPanel panel) {
    JButton button;
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(final ActionEvent e) {
        ...
        final Card card = new Card(selection);
        body.add(card, 0);
        selection = card;
        updateCost();
        body.repaint();
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(final ActionEvent e) {
        ...
        for (int i = 0; i < body.getComponentCount(); i++) {
          final Card card = (Card) body.getComponent(i);
  ...
  private void makeProgrammerButtons(final JPanel panel) {
    JButton button;
